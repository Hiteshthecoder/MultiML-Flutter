...
import 'package:multi_ml/pages/textRecogniser.dart';
      ...
      child: Scaffold(
        floatingActionButton: SpeedDial(
          ...
          children: [
            ...
            SpeedDialChild(
                child: Icon(Icons.face_outlined, color: Get.isDarkMode ? Colors.black : Colors.white),
            ...
            SpeedDialChild(
                child: Icon(Icons.apple_outlined, color: Get.isDarkMode ? Colors.black : Colors.white),
            ...
            SpeedDialChild(
                child: Icon(Icons.masks_outlined, color: Get.isDarkMode ? Colors.black : Colors.white),
                label: 'Mask Detector',
                backgroundColor: Get.isDarkMode ? Colors.white : Colors.grey[700],
                onTap: () {
                  setState(() {
            ...
            SpeedDialChild(
                child: Icon(Icons.image_outlined, color: Get.isDarkMode ? Colors.black : Colors.white),
                label: 'Image to Text',
                backgroundColor: Get.isDarkMode ? Colors.white : Colors.grey[700],
                onTap: () {
                  setState(() {
