...
import 'package:multi_ml/app/widgets/taskTile.dart';
          ...
          floatingActionButton: DescribedFeatureOverlay(
            ...
            tapTarget: SpeedDial(
              ...
              children: [
                ...
                SpeedDialChild(
                    child: Icon(Icons.list_alt, color: Get.isDarkMode ? Colors.black : Colors.white),
                    label: 'To-Do',
                    backgroundColor: Get.isDarkMode ? Colors.white : Colors.grey[700],
                    onTap: () {
                      setState(() {
                ...
                SpeedDialChild(
                    child: Icon(Icons.timer, color: Get.isDarkMode ? Colors.black : Colors.white),
                    label: 'StopWatch',
                    backgroundColor: Get.isDarkMode ? Colors.white : Colors.grey[700],
                    onTap: () {
                      setState(() {
  ...
  Container _addDateBar(size) {
    return Container(
      ...
      child: DatePicker(
        ...
        dateTextStyle: GoogleFonts.lato(fontSize: 18, color: Get.isDarkMode ? Colors.white : Colors.black),
        dayTextStyle: GoogleFonts.lato(fontSize: 16, color: Get.isDarkMode ? Colors.white : Colors.black),
        monthTextStyle: GoogleFonts.lato(fontSize: 16, color: Get.isDarkMode ? Colors.white : Colors.black),
        onDateChange: (date) {
          _selectedDate = date;
          setState(() {});
        },
  ...
  _showTasks(size) {
    return Expanded(child: Obx(() {
      if (_taskController.taskList
          .where((p0) => p0.date == DateFormat.yMd().format(_selectedDate) || p0.repeat == "Daily")
          .isNotEmpty) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Center(
          ...
          label,
          style: isClose
              ? GoogleFonts.lato(fontSize: 18, color: Get.isDarkMode ? Colors.white : Colors.black)
              : GoogleFonts.lato(fontSize: 18, color: Get.isDarkMode ? Colors.white : Colors.black)
