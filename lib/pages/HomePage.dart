...
import 'package:multi_ml/pages/convertors.dart';
import 'package:multi_ml/pages/mlWorld.dart';
            ...
            TweenAnimationBuilder(
              ...
              builder: (_, double val, __) {
                return (Transform(
                  ...
                  child: Scaffold(
                    backgroundColor:
                        Get.isDarkMode ? Color.fromARGB(255, 52, 52, 52) : Color.fromARGB(255, 89, 147, 195),
                    appBar: AppBar(
                      elevation: 0,
