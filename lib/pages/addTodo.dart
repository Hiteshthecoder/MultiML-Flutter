...
import 'package:multi_ml/app/core/task_controller.dart';
import 'package:multi_ml/app/model/alarm_info.dart';
import 'package:multi_ml/app/model/task.dart';
import 'package:multi_ml/app/widgets/inputField.dart';
import 'package:multi_ml/data/local/alarm_helper.dart';
import 'package:multi_ml/main.dart';
...
class _addTodoState extends State<addTodo> {
  ...
  String _endTime = DateFormat("hh:mm a").format(DateTime.now().add(Duration(hours: 3))).toString();
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Text(
                    'Add Tasks',
                    style: GoogleFonts.lato(fontSize: 22, color: Get.isDarkMode ? Colors.white : Colors.black),
                  ),
                  MyInputField(
                    title: 'Title',
                  ...
                  MyInputField(
                    ...
                    widget: DropdownButton(
                      ...
                      iconSize: 28,
                      elevation: 4,
                      style: GoogleFonts.lato(fontSize: 16, color: Get.isDarkMode ? Colors.white : Colors.black),
  ...
  _validateTask() {
    if (_titleController.text.isNotEmpty && _noteController.text.isNotEmpty) {
      ...
      Get.snackbar('Required', 'All fields are required!',
          ...
          backgroundColor: Get.isDarkMode ? Color.fromARGB(255, 40, 40, 40) : Colors.white,
          icon: Icon(
            Icons.warning,
            color: Colors.red,
          ),
  ...
  void scheduleAlarm(DateTime scheduleNotificationDateTime, AlarmInfo alarmInfo) async {
    ...
    Workmanager().registerOneOffTask(alarmInfo.id.toString(), alarmInfo.notifSound!,
        initialDelay: Duration(
            hours: scheduleNotificationDateTime.hour - DateTime.now().hour,
            minutes: scheduleNotificationDateTime.minute - DateTime.now().minute,
            seconds: 0));
  ...
  Column _colorPalet() {
    return Column(
      ...
      children: [
        Text(
          'Color',
          style: GoogleFonts.lato(fontSize: 18, color: Get.isDarkMode ? Colors.white : Colors.black),
        ),
        SizedBox(
          height: 8,
        ),
  ...
  _getDateFromUser() async {
    DateTime? _pickerDate = await showDatePicker(
        context: context, initialDate: DateTime.now(), firstDate: DateTime(2015), lastDate: DateTime(2222));
  ...
  _getTimerFromUser({required bool isStartTime}) async {
    ...
    if (selectedTime != null) {
      ...
      var selectedDateTime = DateTime(now.year, now.month, _selectedDate.day, selectedTime.hour, selectedTime.minute);
