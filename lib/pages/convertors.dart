      ...
      child: Scaffold(
          floatingActionButton: SpeedDial(
            ...
            children: [
              ...
              SpeedDialChild(
                  child: Icon(Icons.currency_exchange_outlined, color: Get.isDarkMode ? Colors.black : Colors.white),
              ...
              SpeedDialChild(
                  child: Icon(Icons.text_fields, color: Get.isDarkMode ? Colors.black : Colors.white),
              ...
              SpeedDialChild(
                  child: Icon(Icons.audiotrack_outlined, color: Get.isDarkMode ? Colors.black : Colors.white),
